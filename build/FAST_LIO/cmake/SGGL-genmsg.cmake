...
add_custom_target(SGGL_generate_messages ALL)
...
add_custom_target(SGGL_generate_messages_cpp
  DEPENDS ${ALL_GEN_OUTPUT_FILES_cpp}
)
add_dependencies(SGGL_generate_messages SGGL_generate_messages_cpp)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/beabbit/study_space/HL_BPR/MSOL/src/FAST_LIO/msg/Pose6D.msg" NAME_WE)
add_dependencies(SGGL_generate_messages_cpp _SGGL_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(SGGL_gencpp)
add_dependencies(SGGL_gencpp SGGL_generate_messages_cpp)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS SGGL_generate_messages_cpp)
...
add_custom_target(SGGL_generate_messages_eus
  DEPENDS ${ALL_GEN_OUTPUT_FILES_eus}
)
add_dependencies(SGGL_generate_messages SGGL_generate_messages_eus)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/beabbit/study_space/HL_BPR/MSOL/src/FAST_LIO/msg/Pose6D.msg" NAME_WE)
add_dependencies(SGGL_generate_messages_eus _SGGL_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(SGGL_geneus)
add_dependencies(SGGL_geneus SGGL_generate_messages_eus)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS SGGL_generate_messages_eus)
...
add_custom_target(SGGL_generate_messages_lisp
  DEPENDS ${ALL_GEN_OUTPUT_FILES_lisp}
)
add_dependencies(SGGL_generate_messages SGGL_generate_messages_lisp)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/beabbit/study_space/HL_BPR/MSOL/src/FAST_LIO/msg/Pose6D.msg" NAME_WE)
add_dependencies(SGGL_generate_messages_lisp _SGGL_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(SGGL_genlisp)
add_dependencies(SGGL_genlisp SGGL_generate_messages_lisp)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS SGGL_generate_messages_lisp)
...
add_custom_target(SGGL_generate_messages_nodejs
  DEPENDS ${ALL_GEN_OUTPUT_FILES_nodejs}
)
add_dependencies(SGGL_generate_messages SGGL_generate_messages_nodejs)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/beabbit/study_space/HL_BPR/MSOL/src/FAST_LIO/msg/Pose6D.msg" NAME_WE)
add_dependencies(SGGL_generate_messages_nodejs _SGGL_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(SGGL_gennodejs)
add_dependencies(SGGL_gennodejs SGGL_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS SGGL_generate_messages_nodejs)
...
add_custom_target(SGGL_generate_messages_py
  DEPENDS ${ALL_GEN_OUTPUT_FILES_py}
)
add_dependencies(SGGL_generate_messages SGGL_generate_messages_py)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/beabbit/study_space/HL_BPR/MSOL/src/FAST_LIO/msg/Pose6D.msg" NAME_WE)
add_dependencies(SGGL_generate_messages_py _SGGL_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(SGGL_genpy)
add_dependencies(SGGL_genpy SGGL_generate_messages_py)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS SGGL_generate_messages_py)
...
if(TARGET geometry_msgs_generate_messages_py)
  add_dependencies(SGGL_generate_messages_py geometry_msgs_generate_messages_py)
endif()
