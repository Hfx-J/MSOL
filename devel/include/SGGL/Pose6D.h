// Generated by gencpp from file msol/Pose6D.msg
// DO NOT EDIT!
...
struct Pose6D_
{
  ...
  typedef boost::shared_ptr< ::msol::Pose6D_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::msol::Pose6D_<ContainerAllocator> const> ConstPtr;

}; // struct Pose6D_

typedef ::msol::Pose6D_<std::allocator<void> > Pose6D;

typedef boost::shared_ptr< ::msol::Pose6D > Pose6DPtr;
typedef boost::shared_ptr< ::msol::Pose6D const> Pose6DConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::msol::Pose6D_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::msol::Pose6D_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::msol::Pose6D_<ContainerAllocator1> & lhs, const ::msol::Pose6D_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::msol::Pose6D_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::msol::Pose6D_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::msol::Pose6D_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::msol::Pose6D_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::msol::Pose6D_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::msol::Pose6D_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::msol::Pose6D_<ContainerAllocator> >
{
  ...
  static const char* value(const ::msol::Pose6D_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xab486e9c24704038ULL;
  static const uint64_t static_value2 = 0x320abf9ff59003d2ULL;
};

template<class ContainerAllocator>
struct DataType< ::msol::Pose6D_<ContainerAllocator> >
{
  static const char* value()
  {
    return "msol/Pose6D";
...
template<class ContainerAllocator>
struct Definition< ::msol::Pose6D_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::msol::Pose6D_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::msol::Pose6D_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::msol::Pose6D_<ContainerAllocator>& v)
  {
